...
class Pokemon(models.Model):
    ...
    title_ru = models.CharField(
        max_length=200, verbose_name='Имя покемона на русском',
        default='покемон')
    title_en = models.CharField(
        max_length=200, blank=True, verbose_name='Имя покемона на английском')
    title_jp = models.CharField(
        max_length=200, blank=True, verbose_name='Имя покемона на японском')
    image = models.ImageField(
        upload_to='pokemons', null=True, blank=True,
        verbose_name='Ваставьте картинку для покемона')
...
class PokemonEntity(models.Model):
    ...
    strength = models.IntegerField(
        null=True, blank=True, verbose_name='Показатель атаки')
    defence = models.IntegerField(
        null=True, blank=True, verbose_name='Показатель защиты')
    stamina = models.IntegerField(
        null=True, blank=True, verbose_name='Показатель выносливости')
